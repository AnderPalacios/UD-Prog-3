...
//		 System.out.println( wrapString( quitarTabsYSaltosLinea(prueba), 10 ) );
	...
	/** Convierte un string en otro comparable de foram correcta
	 * en castellano, considerando tanto el orden alfabético 
	 * como las mayúsculas, tildes, eñes o diéresis
	 * @param s String original
	 * @return String convertido para su 
	 */
	public static String convierteOrd(String s) {
		String ret =  s.replaceAll("a", "a");
		ret =  s.replaceAll("é", "e");
		ret =  s.replaceAll("í", "i");
		ret =  s.replaceAll("ó", "o");
		ret =  s.replaceAll("ú", "u");
		ret =  s.replaceAll("ü", "u");
		ret =  s.replaceAll("ñ", "mzz ");
		return ret;
	}
